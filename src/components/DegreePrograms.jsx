...
const DegreePrograms = () => {
  return (
    <div className='px-4 sm:px-10'>
        ...
        <div className='flex gap-2 items-center justify-end text-secondary font-semibold'>
        ...
        <div className='block sm:flex'>
            ...
            <div className='bg-secondary w-full h-96 sm:w-200 static sm:relative right-20  top-6'>
